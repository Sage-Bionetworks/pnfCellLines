...
#### upload files
snpqc='syn8361436'
scripturl='https://raw.githubusercontent.com/sgosline/pnfCellLines/master/analysis/2017-03-01/qc_figures_snp.R'

for(file in c('rotated_violinBafPlot.pdf','rotated_violinLrrPlot.pdf')){
  synStore(File(file,parentId=snpqc),used=list(list(url=scripturl,wasExecuted=TRUE)))
}